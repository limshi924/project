      ...
      <Link href="#">
        <a>
          <div className="relative">
            ...
            >
              <img
                src={'/images/collections/mo/monkey.png'}
                alt="nft-image"
          ...
          <div className="my-3 px-3">
            <div className="flex justify-between items-center columns-2">
              <div className="flex items-center">
                ...
                <button className="bg-[#ADB5BD] rounded-lg py-[1px] px-4 text-[14px] font-['Circular_Std'] not-italic leading-[18px] font-midium flex items-center text-[#F8F9FA] hover:bg-[#B00000]">
                  sell
                </button>
              </div>
              <div className="flex items-center flex-row-reverse">
                ...
                <img
                  className={
                    showEffect === true
                      ? 'block w-[16px] h-[16px] mr-2'
                      : 'hidden'
                  }
                  src="/images/collections/mo/motor.png"
                />
